...
<body x-data="{ 
    successModalOpen: <?php echo e(session('success') ? 'true' : 'false'); ?>,
            ...
            <?php else: ?>
                ...
                <aside class="hidden lg:block lg:col-span-3 sticky top-24 h-fit space-y-4">
                    <div class="rounded bg-gray-800 p-5 border border-white/5 shadow-xl">
                        ...
                        <div class="space-y-6 max-h-[450px] overflow-y-auto hide-scrollbar relative pl-2">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $sortedHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="relative pl-6 group">
                                    <div class="absolute left-0 top-1.5 h-2 w-2 rounded-full border border-gray-900 z-10 <?php echo e($item['type'] == 'post' ? 'bg-blue-500' : ($item['type'] == 'comment' ? 'bg-emerald-500' : 'bg-pink-500')); ?>"></div>
                                    <div class="flex flex-col">
                                        <span class="text-[8px] font-black text-slate-500 uppercase tracking-widest mb-0.5"><?php echo e($item['label']); ?></span>
                                        <p class="text-[11px] text-slate-300 leading-tight group-hover:text-white transition"><?php echo e($item['desc']); ?></p>
                                        <span class="text-[9px] text-slate-600 font-bold uppercase mt-1 tracking-tighter"><?php echo e($item['time']->diffForHumans()); ?></span>
                                    </div>
                                </div>
                ...
                <div class="lg:col-span-9 space-y-5">
                    ...
                    <div class="rounded p-8 flex flex-col md:flex-row items-center gap-6 border border-white/10 shadow-xl">
                        ...
                        <form action="<?php echo e(route('company.logo.update')); ?>" method="POST" enctype="multipart/form-data" class="relative group flex-shrink-0">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>

                            <label class="cursor-pointer block relative">
                                
                                <img src="<?php echo e($company->company_logo ? route('image.display', ['path' => $company->company_logo]) : 'https://ui-avatars.com/api/?name=' . urlencode($company->company_name) . '&background=1e293b&color=3b82f6'); ?>"
                        ...
                        <div class="text-center md:text-left">
                            <h1 class="text-3xl font-black tracking-tight text-white"><?php echo e($company->company_name); ?></h1>
                            <p class="text-blue-400 text-xs font-black uppercase tracking-[0.2em] mt-2">
                                Registered Company Partner
                            </p>
                            <div class="flex flex-wrap justify-center md:justify-start gap-4 mt-4">
                                <div class="text-center md:text-left">
                                    <p class="text-lg font-bold"><?php echo e($user->followers->count()); ?></p>
                        ...
                        <div class="rounded p-6 border border-white/10 space-y-5">
                            ...
                            <div class="text-sm space-y-4">
                                <div>
                                    ...
                                    <span class="text-slate-200"><?php echo e($company->email); ?></span>
                                </div>
                                <div>
                                    <span class="block text-[10px] text-gray-500 uppercase font-black tracking-widest">Contact Signal</span>
                                    <span class="text-slate-200"><?php echo e($company->contact_number); ?></span>
                                </div>
                                <div>
                                    <span class="block text-[10px] text-gray-500 uppercase font-black tracking-widest">Address</span>
                                    <p class="text-slate-200 text-xs leading-relaxed"><?php echo e($company->address); ?></p>
                                </div>
                                <div>
                        ...
                        <div class="lg:col-span-2 space-y-6">
                            <div class="rounded p-6 border border-white/10">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    <a href="<?php echo e(url('newsfeed')); ?>" class="px-6 py-2.5 bg-blue-600/20 text-blue-400 border border-blue-500/30 hover:bg-blue-600 hover:text-white rounded text-xs font-black tracking-widest transition">
                                        Post Opportunity
                                    </a>
                                    ...
                                    <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($doc['file']): ?>
                                            <li class="p-3 bg-gray-900/50 rounded border border-white/5 flex items-center gap-3">
                                                ...
                                                <a href="<?php echo e(asset('storage/app/public/' . $doc['file'])); ?>" target="_blank" class="text-[11px] font-bold text-slate-300 hover:text-blue-400 truncate">
    ...
    <div id="editModal" class="fixed inset-0 hidden items-center justify-center backdrop-blur-sm z-50 p-4">
        <div class="bg-gray-800 border border-white/10 text-white rounded-2xl w-full max-w-md p-8 relative animate-fadeIn shadow-2xl">
            ...
            <form method="POST" action="<?php echo e(route('company.details.update')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div>
                    <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 block">Company Name</label>
                    <input type="text" name="company_name" value="<?php echo e(old('company_name', $company->company_name)); ?>" class="w-full bg-gray-900 border border-white/5 rounded-xl px-4 py-3 text-sm outline-none focus:border-blue-500 transition">
                </div>
                <div>
                    <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 block">Business Email</label>
                    <input type="email" name="email" value="<?php echo e(old('email', $company->email)); ?>" class="w-full bg-gray-900 border border-white/5 rounded-xl px-4 py-3 text-sm"> 
                </div>
                <div>
                    <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 block">Company Address</label>
                    <input type="text" name="address" value="<?php echo e(old('address', $company->address)); ?>" class="w-full bg-gray-900 border border-white/5 rounded-xl px-4 py-3 text-sm"> 
                </div>
                <div>
                    <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 block">About</label>
                    <textarea name="about" rows="3" class="w-full bg-gray-900 border border-white/5 rounded-xl px-4 py-3 text-sm resize-none"><?php echo e(old('about', $company->about)); ?></textarea>
                </div>
        ...
        <div @click.away="analyticsOpen = false" 
            ...
            <div class="flex flex-wrap border-b border-white/5 bg-gray-800/20 shrink-0">
                ...
                <div class="flex-1 min-w-[100px] p-6 border-r border-white/5">
                    ...
                    <span class="text-2xl font-black text-white"><?php echo e($applications->count()); ?></span>
                </div>
                
                <div class="flex-1 min-w-[100px] p-6 border-r border-white/5">
                    <span class="text-[9px] font-black text-emerald-500 uppercase tracking-widest block">Accepted</span>
                    <span class="text-2xl font-black text-white"><?php echo e($applications->where('status', 'accepted')->count()); ?></span>
                </div>
                
                <div class="flex-1 min-w-[100px] p-6 border-r border-white/5">
                    <span class="text-[9px] font-black text-blue-400 uppercase tracking-widest block">Pending</span>
                    <span class="text-2xl font-black text-white"><?php echo e($applications->where('status', 'pending')->count()); ?></span>
                </div>
                
                <div class="flex-1 min-w-[100px] p-6">
                    <span class="text-[9px] font-black text-red uppercase tracking-widest block">Rejected</span>
                    <span class="text-2xl font-black text-white"><?php echo e($applications->where('status', 'rejected')->count()); ?></span>
                </div>
            </div>
                        ...
                        <div class="group bg-white/5 hover:bg-white/[0.08] border border-white/5 rounded-xl p-5 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="h-12 w-12 rounded overflow-hidden shadow-lg shrink-0 border border-white/10">
                                    <img 
                                        src="<?php echo e($app->student->profile_picture ? route('image.display', ['path' => $app->student->profile_picture]) : 'https://ui-avatars.com/api/?name=' . urlencode($app->student->name) . '&background=0284c7&color=fff'); ?>" 
                                        alt="<?php echo e($app->student->name); ?>"
                                        class="h-full w-full object-cover">
                                </div>
                                <div>
                                    <h4 class="font-bold text-white group-hover:text-blue-400 transition text-base"><?php echo e($app->student->name); ?></h4>
                                    <div class="flex items-center gap-2 mt-0.5">
                                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-tight"><?php echo e($app->post->title ?? 'OJT Position'); ?></span>
                                        <span class="h-1 w-1 rounded-full bg-gray-700"></span>
                                        <span class="text-[10px] font-medium text-blue-400/80"><?php echo e($app->created_at->format('M d, Y')); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between md:justify-end gap-6 border-t md:border-t-0 pt-4 md:pt-0 border-white/5">
                                <div class="flex flex-col items-start md:items-end">
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        <span class="h-2 w-2 rounded-full <?php echo e($app->status == 'accepted' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-red-500'); ?>"></span>
                                        <span class="text-[10px] font-black uppercase tracking-widest <?php echo e($app->status == 'accepted' ? 'text-emerald-500' : 'text-blue-400'); ?>">
                                ...
                                <div class="flex items-center gap-2">
                                    <button @click="selectedApp = { 
                                            slug: '<?php echo e($app->student->slug); ?>',
                                            name: '<?php echo e($app->student->name); ?>', 
                                            email: '<?php echo e($app->student->email); ?>',
                                            contact: '<?php echo e($app->student->contact_number ?? 'Not Provided'); ?>',
                                            profile_photo: '<?php echo e($app->student->profile_picture ? route('image.display', ['path' => $app->student->profile_picture]) : 'https://ui-avatars.com/api/?name=' . urlencode($app->student->name) . '&background=1e293b&color=3b82f6'); ?>',
                                            message: '<?php echo e(addslashes($app->message)); ?>', 
                                            date: '<?php echo e($app->created_at->format('M d, Y')); ?>',
                                            status: '<?php echo e($app->status); ?>',
                                            post: '<?php echo e($app->post->title ?? 'OJT Position'); ?>'
                                    ...
                                    <?php if($app->status == 'pending'): ?>
                                        <form action="<?php echo e(route('applications.update-status', $app->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Kristel Lonzame\Desktop\Website_ojtFinder\htdocs\resources\views/company/company_dashboard.blade.php ENDPATH**/ ?>
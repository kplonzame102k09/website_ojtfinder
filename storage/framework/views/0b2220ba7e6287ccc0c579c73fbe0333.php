...
<div class="max-w-7xl mx-auto px-6 pt-28 pb-16">
    ...
    <div class="glass-card rounded-2xl p-6 min-h-[400px]">
        <div id="users" class="admin-section">
            <?php echo $__env->make('admin.partials.users', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div id="companies" class="admin-section hidden">
            <?php echo $__env->make('admin.partials.companies', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <div id="posts" class="admin-section hidden">
            <?php echo $__env->make('admin.partials.posts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
...
</html><?php /**PATH C:\Users\Kristel Lonzame\Desktop\Website_ojtFinder\htdocs\resources\views/admin/index.blade.php ENDPATH**/ ?>
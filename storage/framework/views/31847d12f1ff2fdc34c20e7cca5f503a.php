...
<body class="bg-main text-slate-200 antialiased relative">
    ...
    <header class="relative pt-32 pb-20 px-6">
        <div class="max-w-7xl mx-auto flex flex-col items-center text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <?php if(auth()->user()->role === 'guest' || !auth()->user()->role): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(auth()->user()->role === 'student' ? route('newsfeed') : route('company_dashboard')); ?>" 
                    class="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-500/25">
                        Go to <?php echo e(ucfirst(auth()->user()->role)); ?> Panel
                    </a>
                <?php endif; ?>
    ...
    <footer class="border-t border-white/5 bg-slate-950/50 py-16 px-6 text-center md:text-left">
        <div class="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-slate-400 font-medium">
                    <li><a href="<?php echo e('home'); ?>" class="hover:text-blue-400">Home</a></li>
                    <li><a href="<?php echo e(('newsfeed')); ?>" class="hover:text-blue-400">Newsfeed</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-slate-400 font-medium">
                    <li><a href="<?php echo e(route('legal.show', 'privacy')); ?>" class="hover:text-blue-400">Privacy Policy</a></li>
                    <li><a href="<?php echo e(route('legal.show', 'terms')); ?>" class="hover:text-blue-400">Terms of Service</a></li>
                </ul>
            </div>
        ...
        <div class="max-w-7xl mx-auto mt-16 pt-8 border-t border-white/5 text-center text-xs text-slate-600 font-bold uppercase tracking-widest">
            © <?php echo e(date('Y')); ?> ojtFinder. All Rights Reserved.
        </div>
    </footer>
    ...
    <div id="alreadyRegisteredModal" class="fixed inset-0 z-[100] hidden flex items-center justify-center p-4">
        ...
        <div class="glass-card w-full max-w-md rounded-2xl p-10 relative shadow-2xl border-blue-500/20 text-center">
            ...
            <p class="text-slate-400 leading-relaxed mb-8">
                Your account is already associated with <span class="text-blue-400 font-bold"><?php echo e(auth()->user()->company->company_name ?? 'a company'); ?></span>.
            </p>
            <div class="space-y-3">
                <a href="<?php echo e(route('company_dashboard')); ?>" class="block w-full py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all">Go to Dashboard</a>
...
<script>   
    ...
    function selectRole(role) {
        if (role === 'student') {
            fetch("<?php echo e(route('user.updateRole')); ?>", {
                method: 'POST',
                headers: {
            ...
            .then(res => res.json())
            .then(() => window.location.href = "<?php echo e(route('newsfeed')); ?>");
            return;
        }
        if (role === 'company') {
            window.location.href = "<?php echo e(route('company.register')); ?>";
        }
    }
...
</html><?php /**PATH C:\Users\Kristel Lonzame\Desktop\Website_ojtFinder\htdocs\resources\views/pages/home.blade.php ENDPATH**/ ?>
                        ...
                        <div class="glass-card rounded p-8 border-l-4 border-l-blue-600">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center gap-6 pb-6 border-b border-white/5">
                                    <div class="relative">
                                        <img :src="photoPreview ? photoPreview : '{{ $user->profile_picture ? route('image.display', ['path' => $user->profile_picture]) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=1e293b&color=fff' }}'"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" name="name" value="{{ old('name', $user->name) }}" class="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-sm text-white focus:ring-1 focus:ring-blue-600">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-slate-500 uppercase">Email Address</label>
                                        <input type="email" name="email" value="{{ old('email', $user->email) }}" class="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-sm text-white focus:ring-1 focus:ring-blue-600">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-slate-500 uppercase">Contact Number</label>
                                        <input type="text" name="contact_number" value="{{ old('contact_number', $user->contact_number) }}" class="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-sm text-white focus:ring-1 focus:ring-blue-600">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-slate-500 uppercase">Address</label>
                                        <input type="text" name="address" value="{{ old('address', $user->address) }}" class="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-sm text-white focus:ring-1 focus:ring-blue-600">
                                    </div>
                                </div>

                                <div class="space-y-2">
                                    <label class="text-[10px] font-black text-slate-500 uppercase">Bio / Description</label>
                                    <textarea name="bio" rows="4" class="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-sm text-white focus:ring-1 focus:ring-blue-600">{{ old('bio', $user->bio) }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="glass-card rounded p-8 border-l-4 border-l-red-500/30">
                            ...
                            <div class="space-y-4 max-w-md">
                                <div class="space-y-2">
                                    ...
                                    @error('current_password') <p class="text-red-500 text-[10px]">{{ $message }}</p> @enderror
                                </div>
                                <div class="space-y-2">
                        ...
                        <div class="space-y-4 max-h-[500px] overflow-y-auto pr-4 custom-scrollbar">
                            ...
                            @forelse($user->activities ?? [] as $activity)
                                <div class="flex items-center justify-between py-3 border-b border-white/5 last:border-0">
                                    <div>
                                        <p class="text-sm text-white font-bold">{{ $activity->description }}</p>
                                        <p class="text-[10px] text-slate-500 uppercase tracking-tight">{{ $activity->created_at->format('M d, Y • h:i A') }}</p>
                                    </div>

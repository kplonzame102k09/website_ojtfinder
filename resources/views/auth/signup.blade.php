  ...
  <div class="relative mx-auto max-w-md w-full bg-slate-800 rounded-xl shadow-2xl overflow-hidden animate-fadeIn">
    ...
    <button type="button" onclick="togglePassword()" class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-indigo-400 transition focus:outline-none px-2 cursor-pointer">
        ...
        <div class="text-slate-500 text-[10px] font-bold uppercase tracking-widest mt-8 border-t border-white/5 pt-6">
            ...
            <a href="{{ route('legal.show', 'terms') }}" class="text-indigo-500 hover:text-indigo-400 transition-colors underline decoration-indigo-500/30 underline-offset-4">Terms</a>,
            <a href="{{ route('legal.show', 'privacy') }}" class="text-indigo-500 hover:text-indigo-400 transition-colors underline decoration-indigo-500/30 underline-offset-4">Privacy Policy</a>,
            and <a href="{{ route('legal.show', 'cookies') }}" class="text-indigo-500 hover:text-indigo-400 transition-colors underline decoration-indigo-500/30 underline-offset-4">Cookies Policy</a>.
        </div>
      ...
      <div class="text-center mt-4 text-sm text-slate-200">
        ...
        <a href="{{ route('login') }}" class="font-semibold text-indigo-500 hover:text-indigo-400 hover:underline transition">Log In</a>
      </div>
    </div>
  </div>
